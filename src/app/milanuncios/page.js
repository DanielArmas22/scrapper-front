// filepath: /buscador-vehiculos/buscador-vehiculos/src/app/milanuncios/page.js
"use client";
import { useState } from "react";
import Link from "next/link";
import SearchForm from "@/components/milanuncios/SearchForm";
import MilanunciosChat from "@/components/milanuncios/MilanunciosChat";
...
import { searchMilanuncios } from "@/services/api";

export default function MilanunciosPage() {
  ...
  return (
    <div className="max-w-4xl mx-auto p-4 pt-8">
      ...
      <h1 className="text-3xl font-bold text-center mb-6 text-gray-800">
        Buscador de Coches en Milanuncios
      </h1>
